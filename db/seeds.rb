...
walmart_bread = Inventory.create(store: walmart, item: bread, price: 5, quantity: 40)
bargain_bread = Inventory.create(store: bargain, item: bread, price: 7, quantity: 23)
kroger_bread = Inventory.create(store: kroger, item: bread, price: 9, quantity: 50)
walmart_milk = Inventory.create(store: walmart, item: milk, price: 2, quantity: 21)
costco_bread = Inventory.create(store: costco, item: bread, price: 3, quantity: 90)